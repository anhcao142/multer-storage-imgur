...
describe('Imgur Storage', function() {
  ...
  it('should process parser/form-data POST request', function(done) {
    ...
    form.append(
      'img',
      fs.createReadStream(path.resolve(__dirname, './files/img2.jpg'))
    );
  ...
  it('should throw error if file is not image', function(done) {
    ...
    form.append(
      'empty',
      fs.createReadStream(path.resolve(__dirname, './files/empty.dat'))
    );
    form.append('name', 'Multer');

    submitForm(parser, form, function(err) {
  ...
  it('should process multiple files', function(done) {
    ...
    form.append(
      'img1',
      fs.createReadStream(path.resolve(__dirname, './files/img1.png'))
    );
    form.append(
      'img2',
      fs.createReadStream(path.resolve(__dirname, './files/img2.jpg'))
